...
<div>
    <div class="mb-8 text-center">
        ...
        <h2 class="text-2xl font-bold text-slate-900">Connexion Commercial</h2>
    ...
    <form wire:submit="login" class="space-y-5">
        ...
        <div>
            ...
            <x-text-input wire:model="form.email" id="email"
                ...
                name="email" required autofocus autocomplete="username" placeholder="commercial@exemple.com" />
