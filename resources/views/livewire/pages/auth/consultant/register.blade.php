...
new #[Layout('layouts.guest', ['theme' => 'consultant'])] class extends Component
{
    ...
    public function register(): void
    {
        ...
        $validated['role'] = UserRole::Consultant;
...
<div>
    <div class="mb-8 text-center">
        ...
        <h2 class="text-2xl font-bold text-slate-900">Inscription Consultant</h2>
        <p class="mt-2 text-sm text-slate-500">
            Créez votre compte consultant pour gérer vos missions
        </p>
    </div>
    ...
    <form wire:submit="register" class="space-y-5">
        ...
        <div>
            ...
            <x-text-input wire:model="email" id="email"
                ...
                autocomplete="username" placeholder="consultant@exemple.com" />
        ...
        <div class="text-center">
            <p class="text-sm text-slate-500">
                Déjà inscrit ?
                <a href="{{ route('consultant.login') }}" wire:navigate
